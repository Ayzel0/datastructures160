...
BSTnode* binarySearchTree::rightRotate(BSTnode* root)
{
...
BSTnode* binarySearchTree::leftRotate(BSTnode* root)
{
...
BSTnode* binarySearchTree::splayNode(BSTnode* root, int value)
{
    ...
    // first case: key is in the left subtree
    if(value < root->value)
    {
        if(root->leftChild = nullptr)
        {
        ...
        {
            root->leftChild->leftChild = splayNode(root->leftChild->leftChild, value);
        ...
        {
            root->leftChild->rightChild = splayNode(root->leftChild->rightChild, value);
    ...
    else
    {
        ...
        {
            // zig zig rotation
            root->rightChild->rightChild = splayNode(root->rightChild->rightChild);
            root = leftRotate(root);
        }
        else if(value < root->rightChild->value)
        {
            // zig zag rotation
            root->rightChild->leftChild = splayNode(root->rightChild->leftChild, value);
